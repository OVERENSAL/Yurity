...
IL_00c2:
	...
	}
	{
		...
		Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 L_26 = __this->___ray_4;
		RaycastHit_t6F30BD0B38B56401CA833A1B87BD74F2ACD2F2B5* L_27 = (&__this->___hit_5);
		bool L_28;
		L_28 = Physics_Raycast_m07803863BB5A3896FA01061562532B21E1ED6D4A(L_26, L_27, NULL);
		if (!L_28)
		{
			goto IL_01fb;
		}
	...
	}
	{
		...
		RaycastHit_t6F30BD0B38B56401CA833A1B87BD74F2ACD2F2B5* L_35 = (&__this->___hit_5);
		...
		RaycastHit_t6F30BD0B38B56401CA833A1B87BD74F2ACD2F2B5* L_41 = (&__this->___hit_5);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_42;
...
IL_0164:
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_46;
		L_46 = Input_get_mousePosition_m2414B43222ED0C5FAB960D393964189AFD21EEAD(NULL);
		NullCheck(L_45);
		...
		__this->___ray_4 = L_47;
		// if (Physics.Raycast(ray, out hit) && hit.collider.gameObject == gameObject)
		Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 L_48 = __this->___ray_4;
		RaycastHit_t6F30BD0B38B56401CA833A1B87BD74F2ACD2F2B5* L_49 = (&__this->___hit_5);
		bool L_50;
		L_50 = Physics_Raycast_m07803863BB5A3896FA01061562532B21E1ED6D4A(L_48, L_49, NULL);
		if (!L_50)
		{
			goto IL_01fb;
		}
	...
	}
	{
		...
		float L_63;
		L_63 = Input_GetAxis_m1F49B26F24032F45FB4583C95FB24E6771A161D4(_stringLiteral88BEE283254D7094E258B3A88730F4CC4F1E4AC7, NULL);
		...
		L_67 = Quaternion_Euler_mD4601D966F1F58F3FCA01B3FC19A12D0AD0396DD_inline(L_59, ((float)il2cpp_codegen_subtract(L_62, ((float)il2cpp_codegen_multiply(L_63, (10.0f))))), L_66, NULL);
		NullCheck(L_56);
		Transform_set_rotation_m61340DE74726CF0F9946743A727C4D444397331D(L_56, L_67, NULL);
	}
